...
class StudentManager(object):
    ...
    def run(self):
        ...
        while True:
            ...
            # 4. 根据用户输入的序号执行不同的功能 -- 例如：如果用户输入1，执行添加功能
            if menu_num == 1:
                # 添加学员
                self.add_student()
            elif menu_num == 2:
    ...
    def add_student(self):
        ...
        # 2. 创建学员对象 -- 类 ？ 类在student文件里面 先到如student模块，在创建对象
    ...
    def search_student(self):
        # 1. 用户输入目标学员姓名
        search_name = input('请输入您要搜索的学员的姓名：')

        # 2. 遍历了表，如果学员存在打印学员信息，否则提示学员不存在
        for i in self.student_list:
